...
def _read_localization_file():
    with open('resources/localization.json', encoding='utf8') as f:
        return json.load(f)


def _extract_localizations_starting_with(prefix):
